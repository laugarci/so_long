...
/*   Updated: 2023/02/21 12:09:49 by laugarci         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_put_player(t_game *game)
{
	if (game->direction == 0)
		...
		game->file = mlx_xpm_file_to_image(game->mlx_init, "./sprites/up.xpm", &game->pxl, &game->pxl);
	else if (game->direction == 2)
		game->file = mlx_xpm_file_to_image(game->mlx_init, "./sprites/left.xpm", &game->pxl, &game->pxl);
	else if (game->direction == 3)
		game->file = mlx_xpm_file_to_image(game->mlx_init, "./sprites/right.xpm", &game->pxl, &game->pxl);
	mlx_put_image_to_window(game->mlx_init, game->mlx_win, game->file, (game->pxl * game->col_x), (game->pxl * game->row_y));
	game->p_y = game->row_y;
	game->p_x = game->col_x;
}
